...
export default function SelectCountry() {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`absolute w-full rounded-lg z-10 bg-[#070F2A] text-white transition-all custom-scroll-bar duration-300 ${
          isDropDown
            ? "max-h-96 mt-5 overflow-y-scroll"
            : "max-h-0 m-0 overflow-hidden"
        }`}
      >

...
export default function EvaluationVerification() {
  ...
  const details = CHALLENGES[0].accountSizes[accountSize].verification;
  ...
  return (
    <div className="bg-[#E6F3E6] p-8 rounded-2xl">
      <div className="grid grid-cols-[auto_1fr] gap-3 items-center border-b pb-4 border-green-500">
        <span className="text-green-500 text-2xl font-semibold">2</span>
        <h4 className="font-medium text-xl">Verification</h4>
      </div>

      <p className="py-4">
        Select an account size and try to reach the profit target for Phase 2.

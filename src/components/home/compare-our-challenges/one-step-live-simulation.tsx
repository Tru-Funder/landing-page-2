...
export default function OneStepLiveSimulation() {
  ...
  const details = CHALLENGES[2].accountSizes[accountSize].liveSimulation;
  ...
  return (
    <div className="bg-[#E6F3E6] p-8 rounded-2xl">
      <div className="grid grid-cols-[auto_1fr] gap-3 items-center border-b pb-4 border-green-500">
        ...
        <h4 className="font-medium text-xl">Live Simulation</h4>
      </div>

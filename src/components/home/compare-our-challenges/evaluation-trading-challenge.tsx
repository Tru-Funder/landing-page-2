...
export default function EvaluationTradingChallenge() {
  ...
  const details = CHALLENGES[0].accountSizes[accountSize].tradingChallenge;
  ...
  return (
    <div className="bg-[#E6F3E6] p-8 rounded-2xl">
      <div className="grid grid-cols-[auto_1fr] gap-3 items-center border-b pb-4 border-green-500">
        ...
        <h4 className="font-medium text-xl">Trading Challenge</h4>
      </div>

      <p className="py-4">
        Select an account size and try to reach the profit target for Phase 1.
        Subject to the rules and objectives, your trading style is completely up
        to you.
      </p>
